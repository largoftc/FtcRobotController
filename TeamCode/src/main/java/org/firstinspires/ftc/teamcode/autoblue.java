...
public class autoblue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (side.equals("center")) {
                ...
                encoderDrive(DRIVE_SPEED, 23, 23, 3);
                encoderDrive(TURN_SPEED, 20.5, -20.5, 3);
                encoderDrive(DRIVE_SPEED, 4, 4, 4);
                armservo2.setPosition(1);
                sleep(1000);
                encoderDrive(DRIVE_SPEED,-50,-50,5);
                encoderDrive(TURN_SPEED, 50, 25, 9);
                encoderDrive(DRIVE_SPEED, 30, 50, 1);
                encoderDrive(TURN_SPEED, 50, 30, 1 );
            }
            sleep(100000);
    ...
    class BlueBlobDetectionPipeline extends OpenCvPipeline {
        ...
        private Mat redMask(Mat frame) {
            ...
            Scalar lowerRed = new Scalar(11, 50, 50);
