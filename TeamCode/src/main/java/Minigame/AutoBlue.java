...
//
    ...
    public void redConeAuto() {
        ...
        moveForwardInches(25, 0.5);
        sleep(1000);
        robot.demoServo.setPosition(0.5);
        robot.demoServo.setPosition(1);
        sleep(1000);
        moveForwardInches(15,0.5);
        TurningNoReverse(-22, -0.3);
        robot.arm.setTargetPosition(400);
        sleep(1000);
        moveForwardInches(16, -0.5);
    ...
    public void blueConeAuto() {
        ...
        robot.arm.setPower(1);
        robot.arm.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        moveForwardInches(21, 0.5);
        robot.demoServo.setPosition(0.5);
        robot.demoServo.setPosition(1);
        sleep(1000);
        moveForwardInches(49,0.5);
        TurningNoReverse(-25, -0.3);
        robot.arm.setTargetPosition(400);
        sleep(1000);
        moveForwardInches(9, -0.5);
        robot.demoServo.setPosition(0);
        sleep(1000);
        moveBackwardInches(52,-1);
        sleep(1000);
