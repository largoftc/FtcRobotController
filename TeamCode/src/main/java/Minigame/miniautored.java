...
@Autonomous (name = "miniautoRed")
public class miniautored extends LinearOpMode{
    ...
    private void initOpenCV() {
        ...
        controlHubCam.setPipeline(new Minigame.miniautored.YellowBlobDetectionPipeline());
